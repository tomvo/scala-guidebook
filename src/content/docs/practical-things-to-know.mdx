...
- **Doctor.** For non-emergencies out of hours, the **Guardia Medica** provides a local on-call doctor — call +39 (0)71 7583800. The nearest **hospitals** are in **Recanati** (Ospedale Santa Lucia, about 15 min) and **Civitanova Marche** (Ospedale Civile, about 20 min). For a medical emergency, call **112**.
